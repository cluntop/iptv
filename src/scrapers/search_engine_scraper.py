...
class FofaScraper(BaseScraper):
    ...
    async def search_iptv_sources(self, country: str = "CN", region: str = None,
                                   isp: str = None, min_port: int = 8000,
                                   max_port: int = 9999) -> List[Hotel]:
...
class HunterScraper(BaseScraper):
    ...
    async def search_iptv_sources(self, country: str = "中国", province: str = None,
                                   city: str = None) -> List[Hotel]:
...
class QuakeScraper(BaseScraper):
    ...
    async def search_udpxy(self, country: str = "中国", province: str = None,
                           isp: str = None) -> List[UDPxy]:
        query_parts = ['udpxy']
...
class MultiSourceScraper(BaseScraper):
    ...
    async def search_iptv_sources(self, country: str = "中国", province: str = None,
                                   isp: str = None, engines: List[str] = None) -> List[Hotel]:
    ...
    async def search_udpxy_sources(self, country: str = "中国", province: str = None,
                                    isp: str = None) -> List[UDPxy]:
