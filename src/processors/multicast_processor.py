...
from ..database import Multicast, UDPxy, MulticastModel, UDPxyModel, Channel, ChannelModel
...
class MulticastProcessor:
    ...
    def process_multicast_channels(self, multicast: Multicast, udpxy_list: List[UDPxy],
                                   categories: List[Any], sign: int = 2) -> List[Channel]:
        channels = []
    ...
    def update_multicast_status(self, multicast_id: int, status: int,
                                lines: int = 0, city: str = None, udpxy: str = None) -> bool:
        try:
