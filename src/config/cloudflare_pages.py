...
class CloudflarePagesConfigManager:
        ...
        config = CloudflarePagesConfig(
            ...
            headers=[
                CloudflarePagesHeader(
                    path="/m3u/*",
                    headers=self.DEFAULT_M3U_HEADERS
                ),
                CloudflarePagesHeader(
                    path="/txt/*",
                    headers=self.DEFAULT_TXT_HEADERS
                ),
                CloudflarePagesHeader(
                    path="/*.m3u",
                    headers=self.DEFAULT_M3U_HEADERS
    ...
    def create_iptv_config(self, output_dir: str = "data/output",
                           include_m3u: bool = True,
                           include_txt: bool = True) -> CloudflarePagesConfig:
        ...
        if include_m3u:
            headers_list.append(CloudflarePagesHeader(
                path="/*.m3u",
                headers=self.DEFAULT_M3U_HEADERS
            ))
    ...
    def add_route(self, config: CloudflarePagesConfig, pattern: str,
                  zone_name: str = None) -> CloudflarePagesConfig:
        config.routes.append(CloudflarePagesRoute(
            pattern=pattern,
            zone_name=zone_name
        ))
        return config
    
    def add_redirect(self, config: CloudflarePagesConfig, from_path: str,
                     to_path: str, status_code: int = 301) -> CloudflarePagesConfig:
        config.redirects.append(CloudflarePagesRedirect(
            from_path=from_path,
            to_path=to_path,
    ...
    def add_header_rule(self, config: CloudflarePagesConfig, path: str,
                        headers: Dict[str, str]) -> CloudflarePagesConfig:
        config.headers.append(CloudflarePagesHeader(
            path=path,
            headers=headers
        ))
        return config
    
    def set_env_var(self, config: CloudflarePagesConfig, key: str,
                    value: str) -> CloudflarePagesConfig:
    ...
    def save_wrangler_toml(self, config: CloudflarePagesConfig, 
                           file_path: str = "wrangler.toml") -> bool:
        try:
    ...
    def save_pages_json(self, config: CloudflarePagesConfig,
                        file_path: str = "pages.json") -> bool:
        try:
    ...
    def save_yaml(self, config: CloudflarePagesConfig,
                  file_path: str = ".cloudflare.yaml") -> bool:
        try:
    ...
    def _dict_to_config(self, data: Dict[str, Any]) -> CloudflarePagesConfig:
        ...
        for r in data.get('routes', []):
            routes.append(CloudflarePagesRoute(
        ...
        for r in data.get('redirects', []):
            redirects.append(CloudflarePagesRedirect(
        ...
        for h in data.get('headers', []):
            headers.append(CloudflarePagesHeader(
                path=h.get('path', ''),
...
class CloudflarePagesService:
    ...
    def save_all_configs(self, output_dir: str = "data/output",
    ...
    def create_headers_file(self, output_dir: str = "data/output",
                            file_path: str = "_headers") -> bool:
...
"""
    ...
    def create_redirects_file(self, redirects: List[Dict[str, str]] = None,
                               file_path: str = "_redirects") -> bool:
        default_redirects = [
